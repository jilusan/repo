...
public partial class publications : System.Web.UI.Page
{
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        if (Page.IsValid == true)
        {
            ...
            email.Subject = "Travel.gc.ca - Publication order from " + txtfullname.Text;
				...
				/*if(ddlcann.SelectedValue.ToString() != "")
            {
                ...
                {
                    sb.AppendLine(" <b>CODE:CLS110B</b> - Advice for cruise travellers fact sheet | Conseils pour les croisières (Bilingual - Bilingue) = <b>" + ddlcruise.SelectedValue.ToString() + "  copies</b><br>");
                }

                if (ddlhow.SelectedValue.ToString() != "")
                {
                    sb.AppendLine(" <b>CODE:CLS004B11</b> - Her Own Way - A Woman's Safe-Travel Guide | Voyager au feminin - La sécurite avant tout (Bilingual - Bilingue) = <b>" + ddlhow.SelectedValue.ToString() + "  copies</b><br>");
                }
                ...
                /*if (ddlroca.SelectedValue.ToString() != "")
                {
                    sb.AppendLine(" <b>CODE:CLS022B11</b> - Registration of Canadians Abroad (fact sheet) (Bilingual - Bilingue) = <b>" + ddlroca.SelectedValue.ToString() + "  copies</b><br>");
                }*/
                ...
                {
                    sb.AppendLine(" <b>CODE:CLS011F14</b> - Un bon départ - Un guide sante à l'intention des voyageurs canadiens (Français) = <b>" + ddlwowfr.SelectedValue.ToString() + "  copies</b><br>");
                }
                ...
                {
                    sb.AppendLine(" <b>CODE:CLS062F12</b> - Enlèvements internationaux d'enfants  = (Francais) = <b>" + ddlchildabductfr.SelectedValue.ToString() + "  copies</b><br>");
                }
                ...
                {
                    sb.AppendLine(" <b>CODE:CLS009B11</b> - A Guide for Canadians Imprisoned Abroad | Guide à l'intention des Canadiens emprisonnes a l'étranger (Bilingual - Bilingue) = <b>" + ddlimprison.SelectedValue.ToString() + "  copies</b><br>");
                }*/
            ...
            form1.Visible = false;
            Response.Redirect("/travelling/publications-reply");
        }
        else
        {
        }
