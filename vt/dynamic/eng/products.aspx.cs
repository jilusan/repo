...
public partial class products : System.Web.UI.Page
{
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        if (Page.IsValid == true)
        {
            ...
            email.Subject = "Travel.gc.ca - Promotional Product Order from " + txtfullname.Text;
            email.Body = "<b>Promotional Product Order Information</b><br><br> " 
                         ...
                         + "<br><br><b>PRODUCT(S) REQUESTED:</b><br>";
               ...
               StringBuilder sb = new StringBuilder();
                ...
                {
                    sb.AppendLine(" <b>CODE:CLS044B08</b> - Away We Go! | Je pars en voyage! (Bilingual) = <b>" + ddlbook.SelectedValue.ToString() + "  copies</b><br>");
                }
            ...
            form1.Visible = false;
            Response.Redirect("/products-reply");
        }
        else
        {
