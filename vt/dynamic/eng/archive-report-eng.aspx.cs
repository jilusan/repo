...
//******************************************************************
public partial class archive_report_eng : System.Web.UI.Page // BasePage //
{
    #region Constants
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            var archiveReport = ArchiveDataFactory.GetArchiveReport("eng", countryId, fileName);
            ...
            LabelDate.Text = date != null ? ((DateTime)date).ToString(date_format) : String.Empty;
            ...
            FrPathParam = "?destination=" + ArchiveDataFactory.GetOppositeLangSlug("eng", slug) + "&archive=" + fileName;
        }
        catch(Exception ex)
        {
