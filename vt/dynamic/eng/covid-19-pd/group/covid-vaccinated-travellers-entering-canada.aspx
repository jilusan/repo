...
<!--#include virtual="/vt/dynamic/eng/covid-19-pd/includes/alert-pre-entry.aspx"-->
...
<ul>
    <li>have received at least 2 doses of a COVID-19 vaccine accepted for travel, a mix of 2 accepted vaccines</li>
    <ul>
    ...
    <li><a href="/travel-covid/travel-restrictions/covid-vaccinated-travellers-entering-canada#pre-entry-testing ">follow pre-entry testing and entry requirements</a>
        <ul>
...
<details>
     ...
     <ul class="fa-ul">
        ...
        <li><span class="fa-li fas fa-check text-success"></span>Moderna (Spikevax, mRNA-1273) including for children aged 6 to 11 years</li>
...
<details>
    ...
    <details>
        ...
        <p class="mrgn-tp-md">If you do not qualify for the fully vaccinated traveller exemption, you may still be able to enter Canada.<br/>
            <a href="/travel-covid/travel-restrictions/wizard-start">Find out if you can enter Canada</a>
        </p>
</details>
...
<details>
	...
	<a href="/travel-covid/travel-restrictions/isolation/quarantine-start" class="btn btn-call-to-action mrgn-lft-lg">Assess your quarantine plan</a>
...
<p class="mrgn-tp-md"><a href="https://www.canada.ca/en/public-health/services/diseases/coronavirus-disease-covid-19/arrivecan/help.html#a6">ArriveCAN general troubleshooting and help</a></p>

<!-- h2 -->
<h2 id="arrival">Arrival tests</h2>

<p>Upon your entry to Canada by air or at a land border crossing, the border services officer may notify you that you have been randomly selected for a mandatory arrival test.</p>
...
<details>
    <summary><span id="selected-arrival-test">Who must take an arrival test if selected to do so upon arrival</span></summary>
    ...
    <ul>
        ...
        <li><strong>Travellers arriving by boat</strong></li>
    ...
    <details>
        <summary><span id="airport-test-providers">Register with airport test providers</span></summary>
        <ul>
     ...
     <details>
       <summary><span id="land-border-test-providers">Land border test providers</span></summary>
    ...
    <details>
        <summary><span id="arrival-test-directions">Completing your arrival test </span></summary>
    ...
    <details>
        <summary><span id="fines-consequences">Fines and consequences of failing to complete the testing
                requirements</span></summary>
    ...
    <details>
        <summary><span id="quarantine-other-invalid-results">Invalid or indeterminate results from your arrival
                test</span></summary>
        <p>You must take another test.</p>
        <ul>
            <li>If you completed your test using a kit: another kit should be automatically couriered to you by
                your testing provider but it is recommended that you contact the provider to ensure a kit is on its way. </li>
            <li>If you were tested on-site at the airport: contact your testing provider to find out how to
                complete a re-test.</li>
        </ul>
    </details>
    ...
    <details>
        <summary><span id="british-columbia">British Columbia, Saskatchewan, Yukon</span></summary>
    ...
    <details>
        <summary><span id="other-provinces">Alberta, Ontario, New Brunswick, Nova Scotia</span></summary>
    ...
    <details>
        <summary><span id="Quebec">Quebec</span></summary>
...
<p>For 14 days following entry into Canada, you and any children who travelled with you must:</p>
<ul>
...
<details>
    <summary> <span id="vaccinated-under-12">Vaccinated children under 12 years of age</span></summary>
    <p>Adults travelling with fully vaccinated children between the ages of 5 to 11 should upload their proof of vaccination into ArriveCAN.</p>
    <p>The benefit of uploading the child’s proof is that, if they are travelling with an adult who does not qualify as fully vaccinated, the child would qualify for all fully vaccinated traveller exemptions.</p>
</details>

<details>
    <summary><span id="unvaccinated-children">Unvaccinated or not fully vaccinated children under 12 years of age</span></summary>
    <p>If you qualify as a fully vaccinated traveller, your unvaccinated or partially vaccinated children are exempt from quarantine, without any limitations on their activities. This means, for example, they don’t need to wait 14 days before attending school, camp or daycare.</p>
    <p>Some federal rules for children entering Canada may be different from the <a h ref="https://travel.gc.ca/travel-covid/travel-restrictions/provinces#requirements">provincial or territorial</a> rules. In this case, you must follow the stricter rules.</p>
</details>

<details>
    <summary> <span id="unvaccinated-youth">Youth aged 12 to 17 years of age</span></summary>
    <p>Unvaccinated and partially vaccinated youth 12 to 17 years of age are subject to the 14-day quarantine, and all testing requirements for pre-entry, arrival and Day-8 tests, whether or not they are accompanied by travellers who qualify as a fully vaccinated traveller.</p>
...
<details>
    <summary> <span id="unvaccinated-dependent">Unvaccinated adult dependents</span></summary>
    <p>Dependents 18 years of age or over who are unvaccinated because of mental or physical limitation may enter but must follow <strong>all testing and quarantine requirements</strong>, even when they are accompanied by parents or guardians who qualify as a fully vaccinated traveller.</p>
    <p><a href="/travel-covid/travel-restrictions/exemptions#unvaccinated ">Follow the checklist of testing and quarantine requirements</a></p>
</details>
        ...
        <section class="provisional single-feature mrgn-bttm-md mrgn-tp-lg row">
            ...
            <figure>
                <div class="pull-left col-md-4"> <a
                        href="https://www.canada.ca/en/public-health/services/diseases/coronavirus-disease-covid-19/covid-alert.html"><img
                ...
                <figcaption class="pull-left col-md-8 h5 mrgn-lft-0 mrgn-tp-0"><a
                        href="https://www.canada.ca/en/public-health/services/diseases/coronavirus-disease-covid-19/arrivecan.html">Use
                        ArriveCAN to enter Canada</a></figcaption>
                <div class="pull-right col-md-8 small">
                    <p>Use ArriveCAN to provide mandatory travel information before your entry into Canada</p>
                </div>
            </figure>
        </section>
