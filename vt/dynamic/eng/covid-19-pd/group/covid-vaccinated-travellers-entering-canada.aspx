...
<details>
     ...
     <ul class="fa-ul">
        ...
        <li><span class="fa-li fas fa-check text-success"></span>Medicago Covifenz
            <ul>
...
<div class="provisional gc-checklist">
	<ul class="lst-none lst-spcd-2">
		...
		<li class="checkbox">
			...
			<label for="receipt"><a href="#set-up-account" data-gc-analytics-customclick="checklist-vaccinated:link:ArriveCAN receipt">ArriveCAN receipt with letter A, I, or V beside the vaccinated traveller’s name</a></label>
		</li>
        ...
        <!-- 4 -->
        <li class="checkbox">
            <input data-gc-analytics-customclick="checklist-vaccinated:checkmark:recovered" type="checkbox" name="recovered" value="1" id="recovered" />
            <label for="recovered"><a href="#already-recovered" data-gc-analytics-customclick="checklist-vaccinated:link:recovered ">If already recovered, bring your proof of a prior positive molecular test result</a></label>
        </li>
...
<details>
    <summary><span id="proof">Upload proof of vaccination in ArriveCAN before you travel</span></summary>        
    <ol class="lst-stps">

        <li><h4 id="locate-proof">Locate the proof you'll need to upload</h4></li>
        <details>
        ...
        <li><h4 id="save-proof">Save or move your proof of vaccination file(s) to have ready to upload</h4></li>
	...
	<li><h4 id="upload-proof">Upload your proof in ArriveCAN in the traveller profile</h4></li>
...
<details>
    <summary><span id="vaccination-questions">You couldn’t upload proof</span></summary>
    <ul>
...
<details>
<summary><span id="contact-ArriveCAN">Getting emails or calls about quarantine or testing</span></summary>
...
<details>
    <summary><span id="already-recovered">Already recovered from COVID-19</span></summary>
    ...
    <details>
        <summary><span id="quarantine-other-invalid-results">Invalid or indeterminate results from your arrival test</span></summary>
...
<details>
    <summary> <span id="children-under-5">Children who are under 5 years of age </span></summary>
...
<details>
    <summary> <span id="children-5-11">Children aged 5 through 11</span></summary>
...
<details>
    <summary> <span id="unvaccinated-youth">Youth aged 12 to 17</span></summary>
        ...
        <section class="provisional single-feature mrgn-bttm-md mrgn-tp-lg row">
            ...
            <figure>
                ...
                <figcaption class="pull-left col-md-8 h5 mrgn-lft-0 mrgn-tp-0"><a
                        href="https://www.canada.ca/en/public-health/services/diseases/coronavirus-disease-covid-19/arrivecan.html">You must use
