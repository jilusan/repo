...
public partial class travel_report_eng : System.Web.UI.Page
{
    ...
    public void Page_Load(object sender, EventArgs e)
    {
        ...
        this.TrIsoCode = report.Iso.ToString();
				...
				Label2.Text = "<div class=\"AdvisoryContainer ExHigh\"><h3>Belgium - Exercise a high degree of caution</h3><p>On June 14, 2017, a commercial airliner crashed in the vicinity of Brussels Airport, <strong>causing casualties. Brussels Airport is currently closed</strong>. Avoid the area and follow the instructions of local authorities. Contact your airline or travel agent to verify how this may affect your travel plans.</p></div>";
				
				Label11.Text = "Commercial airliner crashed";
				//Label12.Text = "June 14, 2017 3:30 EST";
				Label9.Text  = "June 14, 2017 8:30 EST";
