...
public partial class search_eng : BasePage // System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string gsaClient = ConfigFactory.GetConfigEntry("GsaClientEn", "English GSA Client");

        string gsaStylesheet = ConfigFactory.GetConfigEntry("GsaStylesheetEn", "English GSA XSLT Stylesheet");
