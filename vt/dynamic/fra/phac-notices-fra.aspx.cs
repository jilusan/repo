...
public partial class notices : System.Web.UI.Page
{
    ...
    #region General
        ...
        private const string AllCountries = "Tous les pays";
    #endregion
    ...
    private void GetPhacNotices()
    {
        ...
        sb.AppendLine("<thead><tr><th width='130'>" + "Niveau" + "</th><th width='380'>" + "Conseil de santé aux voyageurs" + "</th><th width='275'>" + "Endroit" + "</th><th width='125'>" + "Dernière mise à jour" + "</th><th></th></tr></thead>");
        sb.AppendLine("<tbody>");
        ...
        foreach (Notice notice in noticesList)
        {
            ...
            {
                sb.AppendLine("<img class='datatable-level4' src='/vt/images/thn/risklevels/level4.svg'>&nbsp;<strong>Niveau " + notice.RiskLevel + "</strong></td>");
            }
            else if(notice.RiskLevel == "3") {
                sb.AppendLine("<img class='datatable-level3' src='/vt/images/thn/risklevels/level3.svg'>&nbsp;<strong>Niveau " + notice.RiskLevel + "</strong></td>");
            }
            else if(notice.RiskLevel == "2") {
                sb.AppendLine("<img class='datatable-level2' src='/vt/images/thn/risklevels/level2.svg'>&nbsp;<strong>Niveau " + notice.RiskLevel + "</strong></td>");
            }
            else
            {
                sb.AppendLine("<img class='datatable-level1' src='/vt/images/thn/risklevels/level1.svg'>&nbsp;<strong>Niveau " + notice.RiskLevel + "</strong></td>");
            }
            
            // Add the URL
            sb.AppendLine("<td><a href=\"/voyager/sante-securite/conseils-sante-voyageurs/" + notice.Id + "\">" + notice.Name + "</a></td><td>" + notice.Location + "</td>");
    ...
    private List<Notice> gatherPhacInfo() {
        ...
        for (int i = 0; i < json_col2.Count(); i++) {
            ...
            this_notice.Name         = json_col2[i]["name"]["fra"].ToString();
            ...
            this_notice.Location     = json_col2[i]["locations"]["fra"].ToString(); // countries's name
