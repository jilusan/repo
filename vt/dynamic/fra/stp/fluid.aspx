...
<script runat="server">
	string frPath = "/voyager/agents-de-voyage/intro"; 
    string enPath = "/travelling/safe-travel-planner/intro"; 
	string FilePath = "fluid.aspx";
</script>
...
<!-- CONTENT STARTS HERE -->
<h1 id="wb-cont">Guide de pr&eacute;paration des voyages - Introduction</h1>
