...
<ul>
    ...
    <li><a href="#creer-compte">Utilisation obligatoire d’ArriveCAN (compte, preuve et aide)</a></li>
...
<ul>
    ...
    <li>avoir reçu votre deuxième dose au moins 14 jours civils avant votre entrée au Canada
        <ul>
            <li>Par exemple, si votre dernière dose a été reçue à n’importe quel moment le <strong>jeudi 1er juillet</strong>, alors le <strong>jeudi 15 juillet</strong> serait le premier jour où vous respectez la condition des 14 jours</li>
        </ul>
    </li>
    <li>ne présenter aucun signe ou symptôme de la COVID-19</li>
    <li><a href="https://voyage.gc.ca/voyage-covid/voyage-restrictions/voyageurs-vaccines-covid-entrent-canada#preuve">téléverser votre preuve de vaccination dans ArriveCAN</a>
        <ul>
...
<details>
    ...
    <ul class="fa-ul">
        ...
        <li><span class="fa-li fas fa-check text-success"></span>Covifenz de Medicago
            <ul>
                <li><strong>Remarque à l’intention des voyageurs :</strong> À compter du 25 avril 2022, vous pourrez sélectionner ce vaccin lorsque vous présenterez votre preuve de vaccination dans ArriveCAN</li>
            </ul>
        </li>
...
<div class="provisional gc-checklist">
    <ul class="lst-none lst-spcd-2">
        ...
        <li class="checkbox">
            ...
            <label for="receipt">&nbsp;<a href="#creer-compte" data-gc-analytics-customclick="checklist-vaccinated:link:ArriveCAN receipt">Votre reçu ArriveCAN avec les lettres A, I, ou V à côté du nom du voyageur vacciné </a></label>
        </li>

        <!-- 3 -->
        <li class="checkbox">
            <input data-gc-analytics-customclick="checklist-vaccinated:checkmark:preuve-vaccination" type="checkbox" name="preuve-vaccination" value="1" id="preuve-vaccination" />
            <label for="preuve-vaccination">&nbsp;<a href="/voyage-covid/voyage-restrictions/voyageurs-vaccines-covid-entrent-canada#preuve " data-gc-analytics-customclick="checklist-vaccinated:link:preuve-vaccination">Votre preuve de vaccination qui a été téléversée dans ArriveCAN (copie originale ou papier)
                </a></label>
        </li>

        <!-- 4 -->
        <li class="checkbox">
            <input data-gc-analytics-customclick="checklist-vaccinated:checkmark:retablie" type="checkbox" name="retablie" value="1" id="retablie" />
            <label for="retablie">&nbsp;<a href="#personne-retablie" data-gc-analytics-customclick="checklist-vaccinated:link:retablie">Si vous êtes déjà rétabli, la preuve d’un résultat positif à un test moléculaire effectué au moment de votre infection</a></label>
        </li>
...
<p>Les tests préalables à l’entrée ne sont pas exigés pour les voyageurs entièrement vaccinés qui entrent au Canada par voie terrestre, aérienne ou maritime. <strong>Vous devez continuer d’utiliser ArriveCAN</strong> dans les 72 heures avant votre arrivée au Canada.</p>
<p>Les voyageurs qui montent à bord d’un navire de croisière doivent consulter la page Voyage sur des navires de croisière pour connaître les exigences relatives aux croisières.</p>
<p><strong>À compter du 25 avril 2022, à 00 h 01 (HE)</strong> : Les enfants non vaccinés ou partiellement vaccinés moins de 12 ans n’auront pas à fournir la preuve d’un résultat valide à un test effectué avant l’entrée, s’ils accompagnent un adulte entièrement vacciné.</p>
<p>Les enfants de moins de 5 ans n’ont pas à passer un test, quel que soit leur statut vaccinal.</p>


<h2 id="creer-compte">Utilisation obligatoire d’ArriveCAN (compte, preuve et aide)</h2>

<p><strong>Tous les voyageurs au Canada doivent continuer d’utiliser ArriveCan.</strong> Ceux qui ne se conforment pas à cette obligation pourraient devoir payer une amende de 5 000 $.</p>

<p><strong>Vous prévoyez partir en voyage le 25 avril ou après cette date?</strong> Attendez de soumettre votre formulaire ArriveCAN à l’approche de votre date d’entrée au Canada et mettez à jour votre application le 25 avril à l’aide des nouvelles règles.</p>
...
<ul>
    <li>Pour vous préparer à voyager, <a href="https://www.canada.ca/fr/sante-publique/services/maladies/maladie-coronavirus-covid-19/arrivecan/aide.html#a2">créez gratuitement votre compte ArriveCAN</a>.</li>
    ...
    <li>Pour obtenir un reçu d’ArriveCAN, soumettez vos renseignements de voyage ou votre plan de quarantaine jusqu’à <strong>72 heures</strong> avant votre arrivée au Canada.</li>
</ul>
...
<details>
    <summary><span id="preuve">Téléversez une preuve de vaccination dans ArriveCAN avant votre voyage</span></summary>
    <ol class="lst-stps">
        <li>
...
<details>
    <summary><span id="questions-vaccination">Vous n’avez pas pu téléverser votre preuve</span></summary>
    <ul>
...
<details>
    ...
    <ul>
        ...
        <li>Vous n’avez pas téléchargé votre preuve de vaccination pour chaque voyageur dans votre soumission</li>
        <li>Vous n’avez pas rempli le formulaire ArriveCAN pour votre voyage</li>
        <li>Vous n’avez pas inclus tous les voyageurs dans votre formulaire, vous avez besoin d’un reçu par voyageur</li>
...
<details>
    <summary><span id="communiquer-arrivecan">Recevoir des courriels et des appels concernant la quarantaine et le dépistage</span></summary>
    ...
    <p>Si vous n’avez pas un A, I ou V à côté de votre nom sur votre reçu d’ArriveCAN, vous n’êtes pas admissible à titre de  voyageur entièrement vacciné et recevrez des notifications après votre passage à la frontière.</p>
...
<details>
    <summary><span id="lettres-codes-recu">Il n’y a pas de A, I, ou V sur votre reçu d’ArriveCAN </span></summary>
    ...
    <p>S’il n’y a pas de A, I, ou V à côté de votre nom, soit vous :</p>
    <ul>
        <li>n’êtes pas entièrement vacciné conformément aux exigences du Canada ou</li>
        <li>n’avez pas téléversé de preuve de vaccination (une image pour votre vaccin à dose unique, deux images pour votre vaccin à deux doses, ou une image qui comprend les détails sur vos deux doses)</li>
        <li>voyagez pour des raisons essentielles qui sont exemptées</li>
        <li>avez indiqué une exemption médicale à la vaccination</li>
    </ul>
...
<ul>
    ...
    <li><a href="https://www.canada.ca/fr/sante-publique/services/maladies/maladie-coronavirus-covid-19/arrivecan/communiquez-avec-nous.html">Communiquez avec nous à propos d’ArriveCAN</a></li>
</ul>
<!-- h2 -->
...
<details>
    <summary><span id="selectionne-test-arrivee">Qui doit passer un test d’arrivée si sélectionné à son arrivée</span></summary>
    ...
    <ul>
        ...
        <li><strong>Les personnes qui arrivent par bateau ou traversier</strong></li>
...
<details>
    <summary><span id="personne-retablie">Personne rétablie de la COVID-19</span></summary>
    <p>Vous êtes exempté du test à l’arrivée si vous :</p>
    <ul>
        <li>fournissez un résultat positif à un test moléculaire de dépistage de la COVID 19 effectué au moins 10 jours et pas plus de 180 jours civils avant votre entrée au Canada. Un résultat positif à un test de détection des antigènes n’est pas accepté. </li>
    </ul>
    <p>Le calcul commence le lendemain de votre test. Par exemple : </p>
    <ul>
        <li>si vous avez obtenu un résultat positif à votre test de dépistage moléculaire de la COVID-19 effectué le 1er janvier, le 11 janvier serait la première date à laquelle vous pouvez utiliser ce résultat</li>
...
<p>Si vous atterrissez dans l’un des aéroports figurant dans la liste ci-dessous, vous pourriez être sélectionné pour un test de dépistage aléatoire obligatoire. Si vous êtes sélectionné, vous devrez effectuer un test sur place avant de quitter l’aéroport. Pour accélérer le processus, inscrivez-vous à l’avance auprès du fournisseur de tests à l’aéroport où vous arriverez.</p>
<p>Si l’aéroport où vous vous trouvez n’effectue pas de test sur place, vous n’avez pas à vous inscrire et ne serez pas sélectionné pour un test de dépistage aléatoire.</p>

<h4 id="fournisseurs-test-depistage-aeroport">Inscrivez-vous auprès des fournisseurs de tests de dépistage sur place à l’aéroport</h4>
...
<!--#include virtual="/vt/dynamic/fra/covid-19-pd/includes/airport-test-providers.aspx"-->

<h4 id="frontier-terrestre-fournisseurs-tests">Tests de dépistage à l’arrivée aux frontières terrestres</h4>

<p>Lorsque vous arrivez à un poste frontalier terrestre, si vous êtes sélectionné, vous recevrez une trousse d’autoprélèvement par écouvillon. Vous devrez suivre les instructions incluses dans la trousse pour effectuer votre propre test de dépistage à votre destination.</p>


<h4>Pour effectuer votre test de dépistage à l’arrivée</h4>
<p>Utilisez seulement les trousses de tests que vous avez reçues à la frontière, plutôt que celles que vous pourriez avoir en votre possession. Les instructions, les liens Web et les numéros de téléphone sont tous fournis dans la trousse.</p>
...
<ul>
    ...
    <li>si vous recevez une trousse d’autoprélèvement par écouvillon, à l’aéroport ou au poste frontalier terrestre, suivez les instructions de la trousse pour faire le prélèvement dans les 24 heures suivant votre entrée au Canada. La plupart des voyageurs seront avisés du résultat de leur test dans les 4 à 7 jours.</li>
</ul>
<p>Si vous n’avez pas reçu votre résultat de test dans ces délais, <a href="/voyage-covid/voyage-restrictions/voyageurs-vaccines-covid-entrent-canada#joindre-fournisseur-test">communiquez avec votre fournisseur de tests</a>.</p>
...
<p>Les voyageurs entièrement vaccinés qui arrivent de n’importe quel pays n’ont pas à se mettre en quarantaine en attendant le résultat de leur test, si vous avez été sélectionné au hasard pour effectuer le test de dépistage obligatoire à l’arrivée.</p>
<p><strong>Si un voyageur entièrement vacciné ou un enfant non vacciné de moins de 12 ans reçoit un résultat positif à la suite du test de dépistage à l’arrivée, il doit :</strong></p>
<ul>
    <li>s’isoler pendant 10 jours</li>
    <li>déclarer ses résultats ou ses symptômes à l’ASPC en composant le 1-833-641-0343</li>
</ul>
<p><strong>Si un parent, un beau-parent, un gardien ou un tuteur entièrement vacciné avec qui l’enfant a voyagé présente des symptômes ou reçoit un résultat positif :</strong></p>
<ul>
    ...
    <li>les résultats du test de dépistage ou les symptômes de votre enfant non vacciné doivent être déclarés à l’ASPC en composant le 1-833-641-0343</li>
    <li>l’adulte entièrement vacciné doit se renseigner sur les exigences locales en matière de santé publique afin de les respecter</li>
</ul>
...
<ul>
    <li><strong>À compter du 25 avril 2022 :</strong> Si vous ou vos enfants êtes entièrement vaccinés, vous devrez vous conformer à moins d’exigences fédérales 14 jours suivant votre entrée au Canada. Par exemple, vous n’aurez plus à porter un masque dans les lieux publics ou à déclarer vos signes et vos symptômes en vertu de la loi fédérale. </li>
    <ul>
        <li>Vous devez quand même déclarer tout résultat positif d’un test exigé par le gouvernement si vous êtes sélectionné pour en passer un. </li>
        <li>Vous devez continuer de porter un masque pendant toute la durée de votre voyage (à bord d’un avion ou d’un navire).</li> 
        <li><strong>Remarque :</strong> Certaines règles fédérales peuvent différer des règles provinciales et territoriales. Notamment, vous pouvez être tenu de porter un masque dans les transports en commun de certaines provinces. Dans un tel cas, suivez les règles les plus strictes.</li>
        <li>Même si les masques ne doivent plus être portés durant 14 jours après votre arrivée, vous pouvez en porter un à titre de mesure individuelle de santé publique que vous pouvez facilement prendre pour vous protéger et protéger les autres.</li>
    </ul>
</ul>
...
<details>
    <summary> <span id="enfants-moins-5">Enfants de moins de 5 ans</span></summary>
...
<details>
    <summary> <span id="enfants-5-11">Enfants de 5 à 11 ans</span></summary>
    ...
    <h3>Enfants entièrement vaccinés</h3>
    <p>Les adultes qui voyagent avec des enfants entièrement vaccinés doivent <strong>téléverser la preuve de vaccination de ces derniers dans ArriveCAN</strong>. En tant que voyageurs entièrement vaccinés, ils n’ont pas à fournir la preuve d’un résultat à un test effectué avant l’entrée. Ils sont également exemptés de la mise en quarantaine, et aucune limite ne vise leurs activités. </p>
    <p><strong>Un test à l’arrivée</strong> pour les enfants qui sont admissibles en tant que voyageurs entièrement vaccinés&nbsp;:</p>
    <ul>
        <li>doit être effectué s’ils sont choisis pour un test aléatoire obligatoire</li>
        <li>n’a pas à être effectué automatiquement si le parent qui les accompagne est sélectionné pour un test aléatoire obligatoire</li>
    </ul>

    <h3>Enfants non vaccinés ou partiellement vaccinés de 5 à 11 ans</h3>
    <p><strong>À compter du 25 avril 2022 à 00 h 01 (HE) :</strong> Les enfants non vaccinés et partiellement vaccinés de moins de 12 ans n’auront plus à fournir une preuve du résultat valide de leur test préalable à l’entrée s’ils sont accompagnés d’un adulte entièrement vacciné.</p>
    <p>Ils seront exemptés de la mise en quarantaine, et aucune limite ne sera imposée en ce qui a trait à leurs activités. Cela signifie notamment qu’ils n’auront pas à attendre 14 jours avant de fréquenter l’école, la garderie ou un camp. Par contre, <strong>ils devront porter un masque dans les endroits publics (y compris dans les écoles) pendant 14 jours après leur entrée au Canada.</strong></p>
    <p>Les enfants non vaccinés ou partiellement de 5 à 11 ans <strong>doivent passer un test à l’arrivée</strong> si:&nbsp;</p>
    <ul>
...
<section class="provisional single-feature mrgn-bttm-md mrgn-tp-lg row">
    ...
    <figure>
        ...
        <figcaption class="pull-left col-md-8 h5 mrgn-lft-0 mrgn-tp-0"><a
                href="https://www.canada.ca/fr/sante-publique/services/maladies/maladie-coronavirus-covid-19/arrivecan.html">Vous devez utiliser ArriveCAN pour entrer au Canada</a></figcaption>
...
<!-- Feedback, Page Share--><div class="row row-no-gutters mrgn-tp-xl"><div class="col-sm-7 col-lg-6"><!--#include virtual="/vt/dynamic/fra/covid-19-pd/feedback-widget/feedback-widget.aspx"--></div><div class="col-sm-3 col-sm-offset-1 col-lg-offset-3"><!--#include virtual="/vt/dynamic/fra/covid-19-pd/feedback-widget/page-share.aspx"--></div></div><!-- Date Modified --><!--#include virtual="/vt/dynamic/fra/covid-19-pd/feedback-widget/date-modified-html.aspx"--></main><!--#include virtual="/vt/dynamic/_shared/fra/4-dynamic.aspx"--><!--#include virtual="/vt/dynamic/fra/covid-19-pd/feedback-widget/feedback-widget-script-jquery.aspx"--><p>$(document).ready(function () { $(document).on('click', '#btnGoToCountry', function () { mySelection = $(this).parent().siblings("#CountryDropDown1_ddlCountries").find(":selected").val(); window.location.href = "https://voyage.gc.ca/destinations/" + mySelection + "#sante"; return false; }); }); { "@context":"http://schema.org", "@id": "#wb-main", "@type": "FAQPage", "publisher":{ "@type":"GovernmentOrganization", "@id":"#wb-publisher", "name":"Gouvernment du Canada", "url":"https://www.canada.ca/fr.html" }, "headline": "Questions fréquentes des voyageurs vaccinés", "description":"Principales questions pour les voyageurs vaccinés entrant au Canada", "mainEntity": [{ "@type": "Question", "name": "Vaccins acceptés", "acceptedAnswer": { "@type": "Answer", "text": "</p>

<p>You must have received at least 2 doses of a vaccine accepted for travel, a mix of 2 accepted vaccines or at least 1 dose of the Janssen/Johnson &amp; Johnson vaccine. You must have received your second dose at least 14 calendar days before you enter Canada. Vous devez avoir reçu au moins 2 doses d’un vaccin accepté pour les voyages, un mélange de deux vaccins acceptés ou au moins une dose du vaccin Janssen/Johnson &amp; Johnson. Vous devez avoir reçu votre deuxième dose au moins 14 jours civils avant votre entrée au Canada</p>

<p><a href="https://voyage.gc.ca/voyage-covid/voyage-restrictions/voyageurs-vaccines-covid-entrent-canada?utm_campaign=gac-amc-covid-19-21-22&amp;utm_medium=sdata&amp;utm_source=faqpage&amp;utm_content=vaccines-fr#determiner-entierement">Vérifiez si vous êtes admissible en tant que voyageur entièrement vacciné</a></p>

<p>" } }, { "@type": "Question", "name": "Tests de dépistage avant l’entrée", "acceptedAnswer": { "@type": "Answer", "text": "</p>

<p><strong>À compter du 1er avril 2022</strong>, les tests préalables à l’entrée ne seront plus exigés pour les voyageurs entièrement vaccinés qui entrent au Canada par voie terrestre, aérienne ou maritime. Entre-temps, veuillez respecter les exigences relatives aux tests de dépistage avant l’entrée. Vous devez continuer d’utiliser ArriveCAN avant et après le 1er avril.</p>

<p><a href="https://voyage.gc.ca/voyage-covid/voyage-restrictions/voyageurs-vaccines-covid-entrent-canada?utm_campaign=gac-amc-covid-19-21-22&amp;utm_medium=sdata&amp;utm_source=faqpage&amp;utm_content=pre-entry-test-fr#test-depistage-avant-entree">En savoir plus sur les tests de dépistage avant l'entrée </a></p>

<p>" } }, { "@type": "Question", "name": "Utilisez ArriveCAN pour entrer au Canada", "acceptedAnswer": { "@type": "Answer", "text": "</p>

<p>Vous devez obligatoirement utiliser l’application mobile ArriveCAN ou ouvrir une session dans ArriveCAN à partir d’un ordinateur pour consigner votre statut vaccinal, preuve de vaccination, votre quarantaine et vos renseignements de voyage.</p>
...
<p>Pour vous préparer à voyager, <a href="https://voyage.gc.ca/voyage-covid/voyage-restrictions/voyageurs-vaccines-covid-entrent-canada?utm_campaign=gac-amc-covid-19-21-22&amp;utm_medium=sdata&amp;utm_source=faqpage&amp;utm_content=arrivecan-en#creer-compte">create your free ArriveCAN account s</a></p>
