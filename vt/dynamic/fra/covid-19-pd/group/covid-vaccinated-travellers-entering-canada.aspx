...
<ul>
	<li>avoir reçu au moins 2 doses d’un vaccin COVID-19 accepté pour les voyages, un mélange de deux vaccins acceptés
	<ul>
...
<ul class="fa-ul">
	...
	<li>Moderna (Spikevax, mRNA-1273) y compris pour les enfants de 6 à 11 ans</li>
	<li>Novavax (NVX-COV2373, Nuvaxovid, Covovax)</li>
	<li>Pfizer-BioNTech (Comirnaty, tozinameran, BNT162b2) y compris pour les enfants de 5 à 11 ans</li>
	<li>Sinopharm BIBP (BBIBP-CorV)</li>
	<li>Sinovac (CoronaVac, PiCoVacc)</li>
</ul>

<p>Pour être admissible en tant que personne entièrement vaccinée, vous devez avoir reçu, au moins 14 jours civils avant la journée de votre départ en voyage, l’une ou l’autre des combinaisons suivantes de vaccins :</p>
...
<ul>
	...
	<li>doit contenir, sous forme de texte :
	<ul>
		<li>votre nom</li>
...
<ul>
	...
	<li>Lorsqu’on vous demandera de téléverser votre preuve de vaccination, cliquez sur le bouton « Ajouter fichier/photo » et choisissez le fichier PDF ou la photo que vous avez sauvegardée à l’étape 2 ou utilisez la caméra pour prendre une photo de votre preuve
	<ul>
...
<ul>
	<li><strong>À compter du 25 avril 2022 :</strong> Si vous ou vos enfants êtes entièrement vaccinés, vous devrez vous conformer à moins d’exigences fédérales 14 jours suivant votre entrée au Canada. Par exemple, vous n’aurez plus à porter un masque dans les lieux publics ou à déclarer vos signes et vos symptômes en vertu de la loi fédérale.
...
<ul>
	...
	<li>Urgent besoin d’aide? <a href="https://www.canada.ca/en/public-health/services/diseases/coronavirus-disease-covid-19/arrivecan/contact-us.html">Communtiquez avec ArriveCAN par téléphone ou par courriel</a></li>
...
</script><script id="wb-script" type="application/ld+json">
     {
      ...
      "headline": "Questions fréquentes des voyageurs vaccinés",
      "description":"Principales questions pour les voyageurs vaccinés entrant au Canada",
      "mainEntity": [{
       "@type": "Question",
       "name": "Vaccins acceptés",
       "acceptedAnswer": {
        "@type": "Answer",
        "text": "<p>You must have received at least 2 doses of a vaccine accepted for travel, a mix of 2 accepted vaccines or at least 1 dose of the Janssen/Johnson &amp; Johnson vaccine. You must have received your second dose at least 14 calendar days before you enter Canada.
            ...
            Vous devez avoir reçu au moins 2 doses d’un vaccin accepté pour les voyages, un mélange de deux vaccins acceptés ou au moins une dose du vaccin Janssen/Johnson &amp; Johnson. Vous devez avoir reçu votre deuxième dose au moins 14 jours civils avant votre entrée au Canada 
</p>
     ...
     {
       "@type": "Question",
       "name": "Tests de dépistage avant l’entrée",
       "acceptedAnswer": {
        "@type": "Answer",
        "text": "
 ...
 {
     "@type": "Question",
     "name": "Utilisez ArriveCAN pour entrer au Canada",
     "acceptedAnswer": {
        "@type": "Answer",
        "text": "
         <p>Vous devez obligatoirement utiliser l’application mobile ArriveCAN ou ouvrir une session dans ArriveCAN à partir d’un ordinateur pour consigner votre statut vaccinal, preuve de vaccination, votre quarantaine et vos renseignements de voyage. 
</p>
<ul>
<li>La preuve de vaccination et les documents de voyage peuvent être sauvegardés dans votre profil de voyageur d’ArriveCAN avant tout voyage prévu</li>
<li>L’application ArriveCAN est toujours gratuite
</li>
</ul>
         <p>Pour vous préparer à voyager, <a href='https://voyage.gc.ca/voyage-covid/voyage-restrictions/voyageurs-vaccines-covid-entrent-canada?utm_campaign=gac-amc-covid-19-21-22&amp;utm_medium=sdata&amp;utm_source=faqpage&amp;utm_content=arrivecan-en#creer-compte'>create your free ArriveCAN account
s</a></p>"
        }   
    }]
     }
