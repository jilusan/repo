...
public partial class abonner : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
		...
		if (Validate_Email_Address(emailString))
        {
			...
			string Response1 = Request["g-recaptcha-response"];//Getting Response String Append to Post Method
            bool Valid = false;
            //Request to Google Server
            HttpWebRequest req = (HttpWebRequest)WebRequest.Create
            ("https://www.google.com/recaptcha/api/siteverify?secret=6Lft2AUTAAAAAIJlbwAjYmqgPLiemcqq2pCRe7LT&response=" + Response1);
            try
            {
		...
		{
			//Response.Redirect("http://travel.gc.ca/vt/dynamic/fra/abonne-confirmation.aspx");
		...
		else
		{
            ...
            using (var wb = new WebClient()) 
			{
                var data = new NameValueCollection();
                    ...
                    data["confirm"]            = "one";
                    data["showconfirm"]        = "F";
										data["url"]                = "http://voyage.gc.ca/formulaires/contacte";
			...
			if (Valid)
			{
				...
				//Response.Redirect("http://travel.gc.ca/vt/dynamic/fra/abonne-confirmation.aspx");
				Response.Redirect("http://voyage.gc.ca/formulaires/contacte");
			}else
				{
					RCErrorMessage.Text = "La réponse est requise. S'il vous plaît essayer à nouveau.";
				}
        ...
        {
            //not a valid email. 
            ValidationMessage.Text = "Adresse courriel valide requise";
        }
